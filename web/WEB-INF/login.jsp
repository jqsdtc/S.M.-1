...
<div class="nav-bar" id="nav-bar">
    <ul id="nav-tabs">
        <li class="sigh"><a href="/HandleIndex"><img src="../image/homepage.jpg"></a></li>
        <li><a href=""><img src="../image/05.png">&nbsp;&nbsp;0</a></li>
        <li><a href="/WEB-INF/signup.jsp">注册</a></li>
        <li><a href="/WEB-INF/login.jsp">登录</a></li>
    </ul>
</div>
...
<nav class="navbar navbar-default" role="navigation" id="navbar">
    ...
    <div class="navbar-header">
        <a class="navbar-brand" href="/HandleShow?type=cargo&sign=6">鞋履</a>
    </div>
    <div class="navbar-header">
